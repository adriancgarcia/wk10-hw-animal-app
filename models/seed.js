...
mongoose.connection.on('open', async () => {
    ...
    const allAnimals = [
        {
        name: 'Dog', 
        image: 'https://i.imgur.com/iRADEag.jpeg', 
        species: 'Canine', 
        location: 'global', 
        lifeExpectancy: 10, 
        extinct: false,
        ...
        {
        name: 'Cat', 
        image: 'https://i.imgur.com/9qBZMdF.jpeg',  
        species: 'Feline', 
        location: 'global', 
        lifeExpectancy: 15, 
        extinct: false,
        ...
        {
        name: 'Giant Panda', 
        image: 'https://i.imgur.com/Kg6pxB4.jpeg', 
        species: 'Ursidae', 
        location: 'China', 
        lifeExpectancy: 20, 
        extinct: false,
        ...
        image: 'https://media.savetherhino.org/prod/uploads/2018/05/Parsaloi1.jpg', 
        ...
        {
        name: 'Polar Bear', 
        image: 'https://i.imgur.com/esC7HQg.jpeg', 
